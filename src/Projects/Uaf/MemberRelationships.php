...
class MemberRelationships {
  ...
  public function transforms(array $rows) : array {
    ...
    $rows = T\ValueTransforms::valueMapper($rows, 'Relationship Type', ['UAF Board of Directors' => 'Board Member of', 'UAF Staff' => 'Employee of', 'US Advisory Council Members' => 'Advisory Council Member for']);
